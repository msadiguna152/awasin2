                ...
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                      ...
                      $sql = $this->db->query("SELECT * FROM izin WHERE date(waktu_pengajuan)='$tgl' AND id_pegawai='$id_pegawai'")->num_rows();
                      echo $sql." Pengajuan";
                      ?>
                    </span>
                  </div>
              ...
              <div class="col-md-3 col-sm-4 col-12">
                ...
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                      <?php
                      $sql = $this->db->query("SELECT * FROM izin WHERE status_izin='Ditolak' AND id_pegawai='$id_pegawai'")->num_rows();
                      echo $sql." Pengajuan";
                      ?>
                    </span>
                  </div>
              ...
              <div class="col-md-3 col-sm-4 col-12">
                ...
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                      <?php
                      $sql = $this->db->query("SELECT * FROM izin WHERE status_izin='Diterima' AND id_pegawai='$id_pegawai'")->num_rows();
                      echo $sql." Pengajuan";
                      ?>
                    </span>
                  </div>
