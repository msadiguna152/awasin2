          ...
          <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-lg-10">
                    ...
                    <div class="form-group row">
                      <label class="col-xl-4 col-md-2 col-xs-2"></label>
                      <div class="col-xl-8 col-md-8 col-xs-8">
                        <?php if ($data['foto']!=NULL) { ?>
                        <a class="btn btn-success btn-sm" href="<?= site_url();?>admin/Izin/cetak?kd_jabatan=<?=$data2['kd_jabatan'];?>&id_izin=<?= $data['id_izin'];?>">Cetak Surat</a>
                        <?php } else { ?>
                        <a class="btn btn-success btn-sm disabled" href="">Cetak Surat</a>
                        <?php  } ?>
                      </div>
                    </div>
                  </div>
