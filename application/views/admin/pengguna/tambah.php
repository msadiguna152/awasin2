    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form role="form" enctype="multipart/form-data" action="<?= site_url('admin/Pengguna/insert_proses');?>" method="post">
                <div class="row">
                  <div class="col-lg-1">
                  </div>
                  ...
                  <div class="col-lg-10">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama_pengguna" required="" placeholder="Masukan Nama Pengguna . . .">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="password" required="" placeholder="Masukan Password Pengguna . . .">
                      </div>
                    </div>
