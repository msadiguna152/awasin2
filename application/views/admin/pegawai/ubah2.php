    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form role="form" enctype="multipart/form-data" action="<?= site_url('admin/Golongan/update_proses');?>" method="post">
                <div class="row">
                  <div class="col-lg-1">
                  </div>
                  ...
                  <div class="col-lg-10">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama_golongan" required="" value="<?= $data['nama_golongan'];?>" placeholder="Masukan Nama Golongan . . .">
                        <input type="text" hidden name="id_golongan"  value="<?= $data['id_golongan'];?>">

                      </div>
                    </div>

                    <div class="form-group row">
                      <label for="jenis_golongan" class="col-sm-2 col-form-label">Jenis Golongan</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="jenis_golongan" required="" value="<?= $data['jenis_golongan'];?>" placeholder="Masukan Jenis Golongan . . .">
                      </div>
                    </div>
