    ...
    <div class="sidebar">
      ...
      <nav class="mt-3">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= site_url("pemberi_izin/Beranda"); ?>" class="nav-link <?= $this->session->userdata('menu') == 'Beranda' ? 'active' : ''; ?>">
          ...
          <li class="nav-item">
            <a href="<?= site_url("pemberi_izin/Izin"); ?>" class="nav-link <?= $this->session->userdata('menu') == 'Izin' ? 'active' : ''; ?>">
          ...
          <li class="nav-item <?= $this->session->userdata('menu2') == 'kelola data' ? 'menu-open' : ''; ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= site_url("pemberi_izin/Pegawai"); ?>" class="nav-link <?= $this->session->userdata('menu') == 'Pegawai' ? 'active' : ''; ?>">
              ...
              <li class="nav-item">
                <a href="<?= site_url("pemberi_izin/Pengguna"); ?>" class="nav-link <?= $this->session->userdata('menu') == 'Pengguna' ? 'active' : ''; ?>">
                  <i class="fa fa-caret-right nav-icon"></i>
                  <p>Pengguna</p>
                </a>
              </li>
