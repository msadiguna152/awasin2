...
class Izin extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('pegawai/izin/index',$data);
	...
	public function insert(){
		...
		$this->load->view('pegawai/tema/head');
		$this->load->view('pegawai/tema/menu');
		$this->load->view('pegawai/izin/tambah',$data);
		$this->load->view('pegawai/tema/footer');
	}
	public function insert_proses(){
		$this->Mizin->insert();
		echo '<script language="javascript">alert("Berhasil Di Simpan!"); document.location="'.site_url('pegawai/Izin').'"';
		echo '</script>';
	}
	public function update($id){
		...
		$this->load->view('pegawai/tema/head');
		$this->load->view('pegawai/tema/menu');
		$this->load->view('pegawai/izin/ubah',$data);
		$this->load->view('pegawai/tema/footer');
	}
	public function rincian($id){
		...
		$this->load->view('pegawai/tema/head');
		$this->load->view('pegawai/tema/menu');
		$this->load->view('pegawai/izin/rincian',$data);
		$this->load->view('pegawai/tema/footer');
	}
	public function update_proses(){
		$this->Mizin->update();
		echo '<script language="javascript">alert("Berhasil Di Ubah!"); document.location="'.site_url('pegawai/Izin').'"';
		echo '</script>';
	}
	public function delete($id){
		$this->Mizin->delete($id);
		echo '<script language="javascript">alert("Berhasil Di Hapus!"); document.location="'.site_url('pegawai/Izin').'"';
		echo '</script>';
	}
}
